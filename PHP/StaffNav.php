        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./Academic_Staff.php">Acedemic Staff Management</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./Unit_Management.php">Units</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="./AllocateTeachingStaff.php">Teaching Staff Management</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="./Student_Management.php">Enrolled Student Details</a>
                    </li>    
                ...
                ?>
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li>
                            <button class="btn btn-dark pull-right" type="button" id="staffmyaccountbtn"><i class="far fa-user-circle"></i> My Account</button>
                        </li>
